...
export const metadata: Metadata = { title: { default: 'Redline', template: '%s | Redline' }, description: 'Predict every qualifying and race top 10, score exact-position points, and compete for the Redline championship.' }
